...
```
mkdir -p ~/gpt4all-ui2 && curl -L https://raw.githubusercontent.com/nomic-ai/gpt4all-ui/main/webui.sh -o ~/gpt4all-ui2/webui.sh && chmod +x ~/gpt4all-ui2/webui.sh && cd ~/gpt4all-ui2 && ./webui.sh
```
> **Note**
>
